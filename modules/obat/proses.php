...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_obat(kode_obat,nama_obat,satuan,created_user,updated_user) 
                                            VALUES('$kode_obat','$nama_obat','$satuan','$created_user','$created_user')")
