	...
	class TCPDF {
		...
		protected function setFooter() {
			...
			if ($this->print_footer) {
				...
				// Pastikan $this->footer_font adalah sebuah array sebelum digunakan
				if (isset($this->footer_font) && is_array($this->footer_font) && count($this->footer_font) >= 3) {
    				$this->SetFont($this->footer_font[0], $this->footer_font[1], $this->footer_font[2]);
				} else {
    				// Handle jika $this->footer_font tidak terdefinisi atau tidak lengkap
    				$this->SetFont('helvetica', '', 10); // Atur nilai default jika diperlukan
				}
		...
		public function unichr($c) {
			// Pastikan $c adalah integer
			if (!is_int($c)) {
				// Penanganan jika $c bukan integer
				return '';
			}
