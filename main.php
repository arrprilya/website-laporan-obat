...
<head>
    <meta charset="UTF-8">
    <title>Sistem Informasi Persediaan Stok Obat</title>
    ...
    <!-- Custom inline CSS for text adjustments -->
    <style>
      .header-logo {
        display: flex;
        align-items: center;
...
<body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <div class="header-logo">
            <img src="assets/img/logo-kepriprov.png" alt="Logo" class="logo-img">
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2024 - <a href="www.indrasatya.com">www.agustini.com</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
